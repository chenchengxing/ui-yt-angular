angular.module('ui.yt.demo').controller('AccordionDemoCtrl', function ($scope) {
...
angular.module('ui.yt.demo').controller('ButtonsCtrl', function ($scope) {
  $scope.singleModel = 1;
...
angular.module('ui.yt.demo').controller('CarouselDemoCtrl', function ($scope) {
...
angular.module('ui.yt.demo').controller('CollapseDemoCtrl', function ($scope) {
...
angular.module('ui.yt.demo').controller('DatepickerDemoCtrl', function ($scope) {
...
angular.module('ui.yt.demo').controller('DropdownCtrl', function ($scope, $log) {
  $scope.items = [
    'The first choice!',
...
angular.module('ui.yt.demo').controller('PaginationDemoCtrl', function ($scope, $log) {
  $scope.totalItems = 64;
  $scope.currentPage = 4;
...
angular.module('ui.yt.demo').controller('PopoverDemoCtrl', function ($scope) {
...
angular.module('ui.yt.demo').controller('TabsDemoCtrl', function ($scope, $window) {
  $scope.tabs = [
...
angular.module('ui.yt.demo').controller('TimepickerDemoCtrl', function ($scope, $log) {
...
angular.module('ui.yt.demo').controller('TooltipDemoCtrl', function ($scope) {
