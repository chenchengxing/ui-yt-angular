...
*
*/
angular.module('ui.yt.carousel', ['ui.yt.transition'])
...
.directive('slide', function() {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: 'carousel/template/slide.html',
    scope: {
      active: '=?'
    },
...
angular.module('ui.yt.collapse', ['ui.yt.transition'])
...
angular.module('ui.yt.dateparser', [])
...
angular.module('ui.yt.datepicker', ['ui.yt.dateparser', 'ui.yt.position'])
...
.directive( 'datepicker', function () {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: 'datepicker/template/datepicker.html',
    scope: {
      datepickerMode: '=?',
      dateDisabled: '&'
    },
...
.directive('daypicker', ['dateFilter', function (dateFilter) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: 'datepicker/template/day.html',
    require: '^datepicker',
...
.directive('monthpicker', ['dateFilter', function (dateFilter) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: 'datepicker/template/month.html',
    require: '^datepicker',
    link: function(scope, element, attrs, ctrl) {
      ctrl.step = { years: 1 };
      ctrl.element = element;
...
.directive('yearpicker', ['dateFilter', function (dateFilter) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: 'datepicker/template/year.html',
    require: '^datepicker',
    link: function(scope, element, attrs, ctrl) {
...
.directive('datepickerPopupWrap', function() {
  return {
    ...
    replace: true,
    transclude: true,
    templateUrl: 'datepicker/template/popup.html',
    link:function (scope, element, attrs) {
...
angular.module('ui.yt.modal', ['ui.yt.transition'])
 ...
 */
  .directive('modalBackdrop', ['$timeout', function ($timeout) {
    return {
      restrict: 'EA',
      replace: true,
      templateUrl: 'modal/template/backdrop.html',
      link: function (scope, element, attrs) {
  ...
  .directive('modalWindow', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
    return {
      ...
      templateUrl: function(tElement, tAttrs) {
        return tAttrs.templateUrl || 'modal/template/window.html';
      },
      link: function (scope, element, attrs) {
...
angular.module('ui.yt.pagination', [])
...
.directive('pagination', ['$parse', 'paginationConfig', function($parse, paginationConfig) {
  return {
    ...
    templateUrl: 'pagination/template/pagination.html',
    replace: true,
    link: function(scope, element, attrs, ctrls) {
...
.directive('pager', ['pagerConfig', function(pagerConfig) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: 'pagination/template/pager.html',
    replace: true,
    link: function(scope, element, attrs, ctrls) {
      var paginationCtrl = ctrls[0], ngModelCtrl = ctrls[1];
 ...
 */
angular.module( 'ui.yt.popover', [ 'ui.yt.tooltip' ] )
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: 'popover/template/popover.html'
  };
})
...
angular.module('ui.yt.progressbar', [])
...
.directive('progress', function() {
    return {
        ...
        require: 'progress',
        scope: {},
        templateUrl: 'progressbar/template/progress.html'
    };
})
...
.directive('bar', function() {
    return {
        ...
        templateUrl: 'progressbar/template/bar.html',
...
.directive('progressbar', function() {
    return {
        ...
        templateUrl: 'progressbar/template/progressbar.html',
        link: function(scope, element, attrs, progressCtrl) {
            progressCtrl.addBar(scope, angular.element(element.children()[0]));
        }
    };
});
angular.module('ui.yt.rating', [])
...
.directive('rating', function() {
  return {
    ...
    templateUrl: 'rating/template/rating.html',
    replace: true,
    link: function(scope, element, attrs, ctrls) {
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: 'tabs/template/tabset.html',
    link: function(scope, element, attrs) {
...
.directive('tab', ['$parse', function($parse) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: 'tabs/template/tab.html',
    transclude: true,
    scope: {
      active: '=?',
      heading: '@',
...
angular.module('ui.yt.timepicker', [])
...
.directive('timepicker', function () {
  return {
    ...
    replace: true,
    scope: {},
    templateUrl: 'timepicker/template/timepicker.html',
    link: function(scope, element, attrs, ctrls) {
 ...
 */
angular.module( 'ui.yt.tooltip', [ 'ui.yt.position', 'ui.yt.bindHtml' ] )
...
.provider( '$tooltip', function () {
   ...
   * application.
   *
   *   var app = angular.module( 'App', ['ui.yt.tooltip'], function( $tooltipProvider ) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: 'tooltip/template/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: 'tooltip/template/tooltip-html-unsafe-popup.html'
  };
})
...
angular.module('ui.yt.transition', [])
...
angular.module('ui.yt.typeahead', ['ui.yt.position', 'ui.yt.bindHtml'])
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl:'typeahead/template/typeahead-popup.html',
      link:function (scope, element, attrs) {
...
(function(module) {
try { module = angular.module("carousel/template/carousel.html"); }
catch(err) { module = angular.module("carousel/template/carousel.html", []); }
module.run(["$templateCache", function($templateCache) {
  $templateCache.put("carousel/template/carousel.html",
...
(function(module) {
try { module = angular.module("pagination/template/pagination.html"); }
catch(err) { module = angular.module("pagination/template/pagination.html", []); }
module.run(["$templateCache", function($templateCache) {
  $templateCache.put("pagination/template/pagination.html",
    "<ul class=\"pagination\">\n" +
...
(function(module) {
try { module = angular.module("timepicker/template/timepicker.html"); }
catch(err) { module = angular.module("timepicker/template/timepicker.html", []); }
module.run(["$templateCache", function($templateCache) {
  $templateCache.put("timepicker/template/timepicker.html",
    "<table>\n" +
    "	<tbody>\n" +
